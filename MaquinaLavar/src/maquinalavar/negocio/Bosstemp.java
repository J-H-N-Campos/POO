...
public class Bosstemp
{
    ...
    public Bosstemp(int compRoupas, int compSabao, int compAmaciante)
    {    
        this.compartimentoRoupas = new Reservatorio(10000);
        this.compartimentoSabao = new Reservatorio(50);
        this.compartimentoAmaciante = new Reservatorio(25);
        this.setInitValues(compRoupas,compSabao,compAmaciante);
    }
    private void setInitValues(int compRoupas, int compSabao, int compAmaciante)
    {
        this.compartimentoRoupas = new Reservatorio(10000);
        this.compartimentoSabao = new Reservatorio(50);
        this.compartimentoAmaciante = new Reservatorio(25);
