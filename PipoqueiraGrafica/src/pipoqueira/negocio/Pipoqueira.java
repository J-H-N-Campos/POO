...
public class Pipoqueira
{
    ...
    public Pipoqueira( double valorPipocaPequena, double valorPipocaGrande, double vlrVendido, 
            double nivelPipoca, double nivelAcucar, int nivelSal)
    {       
        this.valorPipocaPequena = valorPipocaPequena;
        this.valorPipocaGrande = valorPipocaGrande;
        this.depositoMilho = new Reservatorio(5000);
        this.depositoAcucar = new Reservatorio(1500);
        this.depositoSal = new Reservatorio(500);
        this.setInitValues(vlrVendido, nivelPipoca, nivelAcucar, nivelSal);
    }
    ...
    private void setInitValues(double vlrVendido, double nivelPipoca, double nivelAcucar, int nivelSal)
    {
        if (vlrVendido >= 0)
        {
            this.valorVendido = vlrVendido;
        }
        this.depositoMilho.adicionar( (int)(nivelPipoca*1000) );
        this.depositoAcucar.adicionar( (int)(nivelAcucar*1000) );
        this.depositoSal.adicionar(nivelSal);
    }
